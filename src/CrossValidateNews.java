...
public class CrossValidateNews {
	...
	private static File TESTING_DIR = new File("train");
	
	private static String[] CATEGORIES = { "frase com preconceito", "frase sobre preconceito"};
    ...
    public static void main(String[] args)
        ...
        for (int fold = 0; fold < NUM_FOLDS; ++fold) {
            ...
            System.out.printf("%5d  %4.2f +/- %4.2f\n", fold,
                              evaluator.confusionMatrix().macroAvgFMeasure(),
